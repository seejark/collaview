...
<head>
	...
	<link rel="stylesheet" href="/css/channel_band.css">
</head>
<body>
	...
	<main id="container" class="container">
		<div class="swiper-container wrap">
			<div class="swiper-wrapper memberList">
				<div class="swiper-slide memberItem">
				...
				<c:forEach var="member" items="${memberList}">
					<div class="swiper-slide memberItem">
						<div class="avatar"><img src="/file/profile/${member.profile_file}" alt="${member.profile_origin}"></div>
						<div class="nickName">${member.nick}</div>
					</div>
				</c:forEach>
			</div>
		</div>
