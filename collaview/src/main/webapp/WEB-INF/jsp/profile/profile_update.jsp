...
<body>
    ...
    <main class="container" id="container">
    	<div class="user-info">
	    	...
	    	<div>
	    		<div class="user-info-nick">${userVO.nick}</div>
	    		<span class="user-info-attitude">
	    			<em>Attitude:</em>
	    			<fmt:formatNumber value="${userVO.score}" type="number" minFractionDigits="2"  maxFractionDigits="2"/>
	    		</span>
	    	</div>
    	</div>
        <div class="content">
            <div class="input id required">
                ...
                <div class="inputWrap spanTag">
                	<div>
	                    <input type="text" class="inputBox readonly" name="id" value="${userVO.id}" readonly>
            ...
            <div class="input email required">
                ...
                <div class="inputWrap">
                    <div class="inputFlexBox">
                        <input type="text" class="inputBox" name="email1" value="${email1}" required>
                        <span>@</span>
            ...
            <div class="input phone required">
                ...
                <div class="inputWrap">
                    <input type="text" class="inputBox" name="phone1" maxlength="3" minlength="3" required value="${phone1}">
                    <input type="text" class="inputBox" name="phone2" maxlength="4" minlength="4" required value="${phone2}">
                    <input type="text" class="inputBox" name="phone3" maxlength="4" minlength="4" required value="${phone3}">
                </div>
            </div>
            <div class="input birth">
                ...
                <div class="inputWrap">
                    ...
                    <div class="day">
                        <input type="text" class="inputBox" name="birthDay" maxlength="2" value="${day}">
                        <span>일</span>
                    </div>
                </div>
            </div>
	    ...
	    <div class="btnBox">
			<button type="button" class="btn signup h45 long bc_point">변경</button>
    ...
    <script>
        $(function(){
            ...
            /* 가입 시 선택했던 이메일 초기 세팅 - S */
			var selectedEmail2 = "${email2}";
			
			var knownDomains = ["naver.com", "gmail.com", "kakao.com", "daum.net"];
			var isKnownDomain = knownDomains.includes(selectedEmail2);
			
			if (isKnownDomain) {
			    $(".email2 .selectList li").each(function(){
			        if($(this).data("value") === selectedEmail2){
			            $(".email2 .selectText").text($(this).text());
			            $(".email2 input[name='email2']").val(selectedEmail2);
			        }
			    });
			} else {
			    $(".email2 .selectText").text("기타");
			    $(".email2 input[name='email2']").val("etc");
			    $("input[name='emailEtc']").removeClass("hidden").val(selectedEmail2);
			}

			/* 가입 시 선택했던 이메일 초기 세팅 - E */
			
			/* 가입 시 선택했던 년도 초기 세팅 - S */
			var selectedYear = "${year}";
			if (selectedYear) {
			    $(".birthYear .selectText").text(selectedYear);
			    $(".birthYear input[name='birthYear']").val(selectedYear);
			}
			/* 가입 시 선택했던 년도 초기 세팅 - E */
			
			/* 가입 시 선택했던 월 초기 세팅 - S */
			var selectedMonth = "${month}";
			if (selectedMonth) {
			    $(".birthMonth .selectText").text(selectedMonth);
			    $(".birthMonth input[name='birthMonth']").val(selectedMonth);
			}
			/* 가입 시 선택했던 월 초기 세팅 - E */
