...
<body>
    ...
    <main class="container" id="container">
        <div class="visual" onclick="location.href='/video_page.do?idx=${video.video}'">
            ...
            <figure class="visual_img"><img src="/file/video/${video.thumbnail_file}" alt="${video.thumbnail_origin}"/></figure>
        </div>
        <div class="contents">
    ...
    <script>
        ...
        var video = (dataList['videoList'] != '' && dataList['videoList'] != undefined) ? true : false; // video 전체 출력됐는지 확인 변수
        var bbs = (dataList['bbsList'] != '' && dataList['bbsList'] != undefined) ? true : false; // bbs 전체 출력됐는지 확인 변수
        ...
        function contentMore(cnt){
            ...
            if($bbsList != undefined && $bbsList != null && $bbsList  != ''){
